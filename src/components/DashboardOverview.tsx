...
export const DashboardOverview: React.FC<DashboardOverviewProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      {/* ============================================================ */}
      {/* FAMILY PULSE — EXECUTIVE SYSTEM HEALTH ACROSS 5 DOMAINS */}
      {/* ============================================================ */}
      <section
        id="section-family-pulse"
        className="bg-white rounded-2xl border border-slate-200/90 p-4 shadow-xs"
      >
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-3 text-xs">
          <div className="flex items-center gap-2">
            <Activity className="h-4 w-4 text-slate-700" />
            <span className="font-semibold text-slate-900 uppercase tracking-wider text-[11px] font-mono">
              Family Pulse
            </span>
          </div>
          <span className="text-[11px] text-slate-500 font-mono">5 DOMAINS SYNCHRONIZED</span>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          ...
          <div
            ...
            className="p-3 rounded-xl bg-slate-50/80 border border-slate-100 hover:bg-slate-100/70 transition-colors cursor-pointer"
          >
            <div className="flex items-center justify-between text-[11px] text-slate-500 mb-1">
              <span className="font-medium">Schedule</span>
              <Calendar className="h-3 w-3 text-blue-500" />
            </div>
            <div className="text-sm font-bold text-slate-900 font-mono">2 Today</div>
            <div className="text-[10px] text-emerald-600 font-medium mt-0.5">0 conflicts · Clear</div>
          </div>
          ...
          >
            ...
            <div className="text-sm font-bold text-slate-900 font-mono">₹4,28,500</div>
            <div className="text-[10px] text-slate-500 mt-0.5">₹1.2L commitments</div>
          </div>
          ...
          >
            ...
            <div className="text-sm font-bold text-slate-900 font-mono">8 Devices</div>
            <div className="text-[10px] text-amber-600 font-medium mt-0.5">AC service due Sat</div>
          </div>
          ...
          >
            ...
            <div className="text-sm font-bold text-slate-900 font-mono">4 Items</div>
            <div className="text-[10px] text-slate-500 mt-0.5">Batch ready (₹2,625)</div>
          </div>

          {/* Pulse 5: Goals */}
          <div
            onClick={() => onNavigateTab('travel')}
            className="p-3 rounded-xl bg-slate-50/80 border border-slate-100 hover:bg-slate-100/70 transition-colors cursor-pointer col-span-2 sm:col-span-1"
          >
            <div className="flex items-center justify-between text-[11px] text-slate-500 mb-1">
              <span className="font-medium">Goals</span>
              <Target className="h-3 w-3 text-sky-500" />
            </div>
            <div className="text-sm font-bold text-slate-900 font-mono">Dec Vacation</div>
            <div className="text-[10px] text-emerald-600 font-medium mt-0.5">100% funded (₹75k)</div>
          </div>
        </div>
      </section>
      ...
      {/* ============================================================ */}
      {/* SECTION: FAMILY RESPONSIBILITIES (DAD, MOM, DAUGHTER, SON, FAMILY) */}
      {/* ============================================================ */}
      <section
        id="section-family-responsibilities"
        className="bg-white rounded-2xl border border-slate-200/90 p-6 shadow-xs hover:border-slate-300 transition-colors"
      >
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-5">
          <div className="flex items-center gap-2.5">
            <div className="h-7 w-7 rounded-lg bg-slate-100 flex items-center justify-center text-slate-700">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-semibold text-slate-900">Family Responsibilities</h2>
                <span className="text-[10px] font-mono font-semibold uppercase tracking-wider bg-slate-100 text-slate-700 px-2 py-0.5 rounded">
                  Distributed Accountability
                </span>
              </div>
              <p className="text-xs text-slate-500 font-normal">
                Anchored to real household entities across parents and children
              </p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
          ...
          <div className="p-3.5 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-semibold text-slate-900">Dad (Virat)</span>
                <span className="text-[10px] font-mono font-semibold text-rose-700 bg-rose-50 px-1.5 py-0.5 rounded border border-rose-200">
                  HIGH
                </span>
              </div>
              <p className="text-xs font-medium text-slate-800">Schedule AC servicing</p>
              <p className="text-[11px] text-slate-500 mt-1">Carrier technician Suresh Kumar due Sat 11 AM</p>
            </div>
            <button
              onClick={() => onNavigateTab('tasks')}
              className="mt-3 w-full py-1 rounded-lg bg-white border border-slate-200 hover:bg-slate-900 hover:text-white text-[11px] font-semibold transition-all text-slate-700"
            >
              Manage (Home)
            </button>
          </div>
          ...
          <div className="p-3.5 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-semibold text-slate-900">Mom (Anushka)</span>
                <span className="text-[10px] font-mono font-semibold text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded border border-amber-200">
                  MED
                </span>
              </div>
              <p className="text-xs font-medium text-slate-800">Prepare school document</p>
              <p className="text-[11px] text-slate-500 mt-1">Vamika Elementary Health declaration for PTM</p>
            </div>
            <button
              onClick={() => onNavigateTab('tasks')}
              className="mt-3 w-full py-1 rounded-lg bg-white border border-slate-200 hover:bg-slate-900 hover:text-white text-[11px] font-semibold transition-all text-slate-700"
          ...
          <div className="p-3.5 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-semibold text-slate-900">Daughter (Vamika)</span>
                <span className="text-[10px] font-mono font-semibold text-blue-700 bg-blue-50 px-1.5 py-0.5 rounded border border-blue-200">
                  MED
                </span>
              </div>
              <p className="text-xs font-medium text-slate-800">Prepare school event material</p>
              <p className="text-[11px] text-slate-500 mt-1">STEM solar system model assembly & test</p>
            </div>
            <button
              onClick={() => onNavigateTab('tasks')}
              className="mt-3 w-full py-1 rounded-lg bg-white border border-slate-200 hover:bg-slate-900 hover:text-white text-[11px] font-semibold transition-all text-slate-700"
          ...
          <div className="p-3.5 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-semibold text-slate-900">Son (Akaay)</span>
              ...
              <p className="text-xs font-medium text-slate-800">Reading goal & shapes</p>
              <p className="text-[11px] text-slate-500 mt-1">15-min sensory puzzle play before 7:30 PM</p>
            </div>
            <button
              onClick={() => onNavigateTab('tasks')}
              className="mt-3 w-full py-1 rounded-lg bg-white border border-slate-200 hover:bg-slate-900 hover:text-white text-[11px] font-semibold transition-all text-slate-700"
          ...
          <div className="p-3.5 rounded-xl border border-slate-200 bg-slate-50/60 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-semibold text-slate-900">Family (All 4)</span>
                <span className="text-[10px] font-mono font-semibold text-rose-700 bg-rose-50 px-1.5 py-0.5 rounded border border-rose-200">
                  HIGH
                </span>
              </div>
              <p className="text-xs font-medium text-slate-800">Review Dec vacation budget</p>
              <p className="text-[11px] text-slate-500 mt-1">₹75,000 pot ready; finalize Shimla flights</p>
            </div>
            <button
              onClick={() => onNavigateTab('travel')}
              className="mt-3 w-full py-1 rounded-lg bg-slate-900 text-white text-[11px] font-semibold transition-all shadow-xs hover:bg-slate-800"
            >
              Plan Trip (Travel)
            </button>
          </div>
